        ...
        SetClickPoints:
            {
                ...
                checkPoints.push("equip1","equip2","equip3","equip4","equip5","equip6","equip7","equip8","equip1_levelUp","equip2_levelUp","equip3_levelUp","equip4_levelUp","equip5_levelUp","equip6_levelUp","equip7_levelUp","equip8_levelUp","equip_classD","equip_classC","equip_classB")
                
                SetTimer, SetClickPointsTimer, 100
                For index, value in checkPoints
                {
                    ...
                    Send {Enter}%value% `t%xOffsetRation% `t%yOffsetRation%		
                }
                tooltip,
                SetTimer, SetClickPointsTimer, off
                return
            }
