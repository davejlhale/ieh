...
findKongGameContainer(){
    ...
    if ErrorLevel 
        ...
        tracelog("error finding game container " ErrorLevel)
        return ErrorLevel
    }
    ...
    tracelog("game container found:" vGameContainerX1 " " vGameContainerY1 " " vGameContainerX2 " " vGameContainerY2  " w"vGameContainerWidth " h"vGameContainerHeight)
    return 
}