...
WatchForChilli(){
    ...
    global begin_x, begin_y ,ChilliScanPoint
    global vHwnd
    
    WinActivate ahk_id %vHwnd%
    
    gameClickX :=round((vGameContainerWidth * ChilliScanPoint.x)+begin_x)
    gameClickY := round((vGameContainerHeight * ChilliScanPoint.y)+begin_y)
